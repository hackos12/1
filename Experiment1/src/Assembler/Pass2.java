...
BufferedReader b1 = new BufferedReader(new FileReader("E:\\Java Folder\\Experiment1\\src\\intermediate.txt"));
BufferedReader b2 = new BufferedReader(new FileReader("E:\\Java Folder\\Experiment1\\src\\symtab.txt"));
BufferedReader b3 = new BufferedReader(new FileReader("E:\\Java Folder\\Experiment1\\src\\literal.txt"));
FileWriter f1 = new FileWriter("E:\\Java Folder\\Experiment1\\src\\Pass2.txt");
